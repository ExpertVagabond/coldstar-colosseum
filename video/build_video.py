...
SLIDES = [
    ...
    (
        ...
        [
            ...
            "for Solana",
            "",
            "STIE Member | coldstar.dev",
            "@buildcoldstar | coldstar.dev",
        ],
    ...
    (
        ...
        "Coldstar was built for the Colosseum Agent Hackathon as Project #62 and was recognized by Superteam Earn. The platform is live at coldstar.dev with over 2,500 lines of production Python and DAO programs deployed on Solana devnet. Over 1,800 commits across projects. Built and shipped Coldstar in a 10-day sprint.",
        13,
        "#0a0a0a",
        "#58d1eb",
    ),
...
def create_slide_image(idx, title, body_lines, bg_color, accent_color):
    ...
    cmd = [
        ...
        "-fill", "#444444",
        "-gravity", "South",
        "-annotate", "+0+30", "coldstar.dev | @buildcoldstar | FairScale Fairathon 2026",
        out_path,
    ]
